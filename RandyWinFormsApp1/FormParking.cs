...
namespace RandyWinFormsApp1
{
    ...
    {
        //private ParkingLotAPIResponse parkingLotAPIResponse;
        public FormParking()
        {
            InitializeComponent();
            textBoxURL.Text = "https://data.tycg.gov.tw/opendata/datalist/datasetMeta/download?id=f4cc0b12-86ac-40f9-8745-885bddc18f79&rid=0daad6e6-0632-44f5-bd25-5e1de1e9146f";
            //parkingLotAPIResponse = new ParkingLotAPIResponse
            //{
        ...
        private void buttonDownload_Click(object sender, EventArgs e)
        {
            ...
            using (HttpClient http = new HttpClient())
            {
                ...
                dataGridViewParkingData.DataSource = parkingLotAPIResponse.ParkingLots;
        ...
        private void buttonExcel_Click(object sender, EventArgs e)
        {
            ...
            using (HttpClient http = new HttpClient())
            {
                ...
                {
                    dataGridViewParkingData.Columns[i].HeaderText = headerNames[i];
                }
